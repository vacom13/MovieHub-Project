...
new autoComplete({
    ...
    selector: "#search-input",           // Input field selector              | (Optional)
    ...
    resultsList: {                       // Rendered results list object      | (Optional)
        ...
        destination: document.querySelector("#box"),
        position: "afterend",
        element: "ul"
    },
    ...
    onSelection: feedback => {             // Action script onSelection event | (Optional)
        document.getElementById('search-input').value = feedback.selection.value;
    }
});